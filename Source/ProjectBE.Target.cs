...
public class ProjectBETarget : TargetRules
{
    public ProjectBETarget(TargetInfo Target) : base(Target)
    {
        ...
        ProjectBETarget.ApplySharedLyraTargetSettings(this);
    }
        ...
        else
        {
            ...
            else
            {
                ...
                if (!bHasWarnedAboutShared)
                {
                    ...
                    Logger.LogWarning("ProjectBEEOS and dynamic target options are disabled when packaging from an installed version of the engine");
                }
            }
        }
    }
